...
**tubongeApp Blog App** is an social blog web app built using Ruby on Rails, allowing users to create, read, comment on, and like posts.
...
```sh  
   git clone git@github.com:ProgramKingAbel/tubongeApp.git
   cd tubongeApp
```
